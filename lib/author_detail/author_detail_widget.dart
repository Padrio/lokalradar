...
class AuthorDetailWidget extends StatefulWidget {
  AuthorDetailWidget({Key key}) : super(key: key);

  @override
  _AuthorDetailWidgetState createState() => _AuthorDetailWidgetState();
}

class _AuthorDetailWidgetState extends State<AuthorDetailWidget> {
